...
struct MeshBackground: View {
    var body: some View {
        ZStack {
            ...
            LinearGradient(
                colors: [PrecisionCalMacroAutopsyTheme.bgTop, PrecisionCalMacroAutopsyTheme.bgBottom],
                startPoint: .top,
                endPoint: .bottom
            )
            .ignoresSafeArea()
    ...
    private var warmBlobs: some View {
        ZStack {
            ...
            Circle()
                .fill(PrecisionCalMacroAutopsyTheme.fatColor.opacity(0.18))
                .frame(width: 300, height: 300)
                .blur(radius: 130)
                .offset(x: 150, y: 320)

            Circle()
                .fill(PrecisionCalMacroAutopsyTheme.sageLight.opacity(0.10))
