                ...
                RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: cornerRadius, style: .continuous)
                            .stroke(
                                LinearGradient(
                                    colors: [Color.white.opacity(0.85), PrecisionCalMacroAutopsyTheme.glassStroke],
                                    startPoint: .topLeading, endPoint: .bottomTrailing
                                ),
                                lineWidth: 1
                            )
                    )
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.06), radius: 20, x: 0, y: 8)
            }
    }
}
        ...
        Button {
            ...
            label()
                ...
                .background {
                    ...
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.35), radius: 18, x: 0, y: 10)
                }
                .overlay {
...
struct BreathingOrb: View {
    var size: CGFloat = 60
    var color: Color = PrecisionCalMacroAutopsyTheme.terracotta
