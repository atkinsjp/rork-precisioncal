...
final class BarcodeService {
    ...
    func fetchProductData(barcodeID: String, context: ModelContext) async throws -> ScannedProduct {
        ...
        // 5) Seed the Global_UPC collection so every other PrecisionCalMacroAutopsy user gets it instantly.
    ...
    private func fetchOpenFoodFacts(barcode: String) async throws -> String {
        ...
        req.setValue("PrecisionCalMacroAutopsy/1.0 (https://rork.app)", forHTTPHeaderField: "User-Agent")
