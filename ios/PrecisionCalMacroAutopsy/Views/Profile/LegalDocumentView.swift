...
struct LegalDocumentView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("PrecisionCalMacroAutopsy, operated by Atkins Media.")
                .font(.system(size: 14))
    ...
    private static let privacySections: [(String, String)] = [
        ...
        ("7. Children",
         "PrecisionCalMacroAutopsy is not directed to children under 13. If you believe a child has provided us personal information, contact support@atkins-media.com and we will delete it."),
    ...
    private static let termsSections: [(String, String)] = [
        ("1. Eligibility",
         "You must be at least 13 years old (or the age of digital consent in your country) to use PrecisionCalMacroAutopsy."),
        ("2. Your Account",
        ...
        ("3. Acceptable Use",
         "Do not post content that is disrespectful, medically dangerous, or unlawful. The Stewardship Filter may flag and hide such content and route it for review. Do not attempt to reverse engineer, scrape, or interfere with PrecisionCalMacroAutopsy's services. Do not use PrecisionCalMacroAutopsy to provide medical advice to others."),
        ("4. Health Disclaimer",
         "PrecisionCalMacroAutopsy is an educational wellness companion. It is not a doctor, dietitian, or medical device, and it does not provide medical advice, diagnosis, or treatment. Chats with Cal, meal analyses, calibrations, and product reviews are general educational information only. Always consult a licensed healthcare professional before making changes to your diet, supplements, or medications. In an emergency, call 911 or your local emergency number."),
        ...
        ("6. Intellectual Property",
         "All software, content, and trademarks in PrecisionCalMacroAutopsy are owned by Atkins Media or its licensors and are protected by intellectual property laws. You retain ownership of the content you submit, and grant us a worldwide, royalty-free license to host and display it solely to operate the service."),
        ("7. Termination",
