            ...
            VStack(spacing: 0) {
                ...
                Button {
                    ...
                    accountRowLabel(
                        ...
                        tint: PrecisionCalMacroAutopsyTheme.textPrimary,
        ...
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text(label)
                    ...
                    .foregroundStyle(tint == .red ? Color.red : PrecisionCalMacroAutopsyTheme.textPrimary)
                Text(sublabel)
                    .font(.system(size: 12))
        ...
        Button {
            ...
            HStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 3) {
                    Text(store.isPremium ? "PrecisionCalMacroAutopsy Pro" : "Upgrade to Pro")
                ...
                RoundedRectangle(cornerRadius: 22, style: .continuous)
                    ...
                    .overlay {
                        RoundedRectangle(cornerRadius: 22, style: .continuous)
                            .stroke(
                                LinearGradient(
                                    colors: [PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.5), PrecisionCalMacroAutopsyTheme.glassStroke],
                                    startPoint: .topLeading, endPoint: .bottomTrailing
                                ),
                                lineWidth: 1
                            )
                    }
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.12), radius: 14, x: 0, y: 8)
            }
        }
        .buttonStyle(.plain)
    }
            ...
            VStack(spacing: 14) {
                HStack(spacing: 16) {
                    ZStack {
                        Circle()
                            .fill(
                                LinearGradient(colors: [PrecisionCalMacroAutopsyTheme.terracotta, PrecisionCalMacroAutopsyTheme.fatColor], startPoint: .topLeading, endPoint: .bottomTrailing)
                            )
    ...
    private func targetsCard(_ p: UserProfile) -> some View {
        GlassCard {
            VStack(alignment: .leading, spacing: 14) {
                ...
                TargetRow(icon: "flame.fill", color: PrecisionCalMacroAutopsyTheme.proteinColor, label: "Calories", value: "\(p.dailyCalorieTarget) cal")
                TargetRow(icon: "bolt.fill", color: PrecisionCalMacroAutopsyTheme.proteinColor, label: "Protein", value: "\(p.dailyProteinTarget) g")
                TargetRow(icon: "leaf.fill", color: PrecisionCalMacroAutopsyTheme.carbColor, label: "Carbs", value: "\(p.dailyCarbTarget) g")
                TargetRow(icon: "drop.halffull", color: PrecisionCalMacroAutopsyTheme.fatColor, label: "Fat", value: "\(p.dailyFatTarget) g")
                TargetRow(icon: "drop.fill", color: PrecisionCalMacroAutopsyTheme.hydrationColor, label: "Water", value: "\(p.dailyWaterTargetMl) ml")
            }
            .padding(20)
        }
    }
    ...
    private var calibrationCard: some View {
        VStack(spacing: 12) {
            ...
            Button {
                ...
                HStack(spacing: 10) {
                    ...
                    if !store.hasAccess && !calibrating {
                        Text("PRO")
                            ...
                            .padding(.vertical, 2)
                            .background(Capsule().fill(PrecisionCalMacroAutopsyTheme.terracotta))
                    }
                }
                .foregroundStyle(PrecisionCalMacroAutopsyTheme.textPrimary)
                ...
                .background {
                    Capsule().fill(
                        LinearGradient(
                            colors: [PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.28), PrecisionCalMacroAutopsyTheme.terracottaDeep.opacity(0.32)],
                            startPoint: .topLeading, endPoint: .bottomTrailing
                        )
                    )
                    .overlay {
                        Capsule().stroke(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.55), lineWidth: 1)
                    }
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.18), radius: 8, x: 0, y: 4)
                }
            }
            .buttonStyle(.plain)
            ...
            NavigationLink(value: ProfileRoute.calibrationHistory) {
                ...
                .background {
                    Capsule().stroke(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.4), lineWidth: 1)
                }
            }
            .buttonStyle(.plain)
        }
        ...
        .background {
            RoundedRectangle(cornerRadius: 24, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 24, style: .continuous)
                        .stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.55), lineWidth: 1)
                }
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.08), radius: 14, x: 0, y: 8)
        }
    }
            ...
            GlassCard(cornerRadius: 18) {
                HStack {
                    Image(systemName: "arrow.counterclockwise")
                        .foregroundStyle(PrecisionCalMacroAutopsyTheme.proteinColor)
        ...
        Text(text)
            ...
            .background {
                Capsule()
                    ...
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.15), radius: 12, x: 0, y: 6)
            }
    }
}
