...
struct DisclaimerSheet: View {
        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    section(
                        title: "Emergencies",
                        body: "PrecisionCalMacroAutopsy cannot help in an emergency. If you or someone you know may be in danger, call 911 (US) or your local emergency number immediately."
                    )
    ...
    private var sourcesSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Nutrition targets, calorie estimates, and educational guidance in PrecisionCalMacroAutopsy are derived from the following peer-reviewed and governmental sources. Tap any source to view it.")
                .font(.system(size: 13))
                .foregroundStyle(PrecisionCalMacroAutopsyTheme.textSecondary)
                .lineSpacing(3)
