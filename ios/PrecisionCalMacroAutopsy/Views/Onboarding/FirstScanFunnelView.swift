...
struct FirstScanFunnelView: View {
    ...
    private var mealThumbnail: some View {
        Color(.secondarySystemBackground)
            ...
            .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.18), radius: 18, x: 0, y: 10)
    }
        ...
        VStack(spacing: 0) {
            ...
            ZStack {
                Circle()
                    .fill(
                        RadialGradient(
                            colors: [PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.4), PrecisionCalMacroAutopsyTheme.terracotta.opacity(0)],
...
private struct ConfettiBurst: View {
    ...
    private let palette: [Color] = [
        ...
        PrecisionCalMacroAutopsyTheme.fatColor,
        PrecisionCalMacroAutopsyTheme.sageLight
    ]
