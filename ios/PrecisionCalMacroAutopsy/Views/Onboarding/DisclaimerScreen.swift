...
struct DisclaimerScreen: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("PrecisionCalMacroAutopsy is a wellness companion. It is not a doctor, dietitian, or medical device.")
                .font(.system(size: 15))
    ...
    private var checks: some View {
        VStack(spacing: 10) {
            checkRow(
                ...
                text: "I understand PrecisionCalMacroAutopsy provides educational information only and is not official nutrition, medical, or mental-health advice."
            )
            checkRow(
                isOn: $medicalChecked,
        ...
        Button {
            ...
            HStack(alignment: .top, spacing: 12) {
                ZStack {
                    RoundedRectangle(cornerRadius: 6, style: .continuous)
                        .stroke(isOn.wrappedValue ? PrecisionCalMacroAutopsyTheme.terracotta : PrecisionCalMacroAutopsyTheme.glassStroke, lineWidth: 1.5)
            ...
            .background {
                RoundedRectangle(cornerRadius: 16, style: .continuous)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 16, style: .continuous)
                            .stroke(isOn.wrappedValue ? PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.5) : PrecisionCalMacroAutopsyTheme.glassStroke, lineWidth: 1)
                    )
            }
        }
        .buttonStyle(.plain)
