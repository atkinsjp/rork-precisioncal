        ...
        GeometryReader { geo in
            ZStack {
                GlassShape()
                    ...
                    .overlay {
                        GlassShape().stroke(PrecisionCalMacroAutopsyTheme.glassStroke, lineWidth: 2)
                    }
                ...
                GlassShape()
                    ...
                    .overlay {
                        WaterFill(progress: progress, t: t)
                            .fill(
                                LinearGradient(
                                    colors: [PrecisionCalMacroAutopsyTheme.hydrationColor.opacity(0.95), PrecisionCalMacroAutopsyTheme.sageLight.opacity(0.85)],
                ...
                GlassShape()
                    .stroke(
                        LinearGradient(
                            colors: [.white.opacity(0.85), PrecisionCalMacroAutopsyTheme.glassStroke],
