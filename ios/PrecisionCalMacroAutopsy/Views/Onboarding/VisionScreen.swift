    ...
    var body: some View {
        LinearGradient(
            stops: [
                ...
                .init(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.0), location: 0.35),
                .init(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.35), location: 0.5),
                .init(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.0), location: 0.65),
