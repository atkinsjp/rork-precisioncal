...
struct ProtocolScreen: View {
    ...
    private var parchmentCard: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Divider().background(PrecisionCalMacroAutopsyTheme.glassStroke)
        ...
        .background {
            RoundedRectangle(cornerRadius: 24, style: .continuous)
                .fill(PrecisionCalMacroAutopsyTheme.parchment)
                .overlay {
                    RoundedRectangle(cornerRadius: 24, style: .continuous)
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.10), radius: 24, x: 0, y: 14)
        }
    }
