...
private struct DialKnob: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                .stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.5), lineWidth: 10)
            Circle()
                .trim(from: 0, to: progress)
                .stroke(
                    AngularGradient(colors: [PrecisionCalMacroAutopsyTheme.terracotta, PrecisionCalMacroAutopsyTheme.fatColor, PrecisionCalMacroAutopsyTheme.terracotta], center: .center),
