    ...
    private var disclaimerBanner: some View {
        ...
        .background {
            RoundedRectangle(cornerRadius: 14, style: .continuous)
                .fill(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.07))
                .overlay(
                    RoundedRectangle(cornerRadius: 14, style: .continuous)
                        .stroke(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.22), lineWidth: 0.8)
                )
        }
    }
            ...
            HStack {
                ...
                Button {
                    ...
                    .background {
                        ...
                        .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.45), radius: 18, x: 0, y: 10)
                    }
                }
                .buttonStyle(.plain)
                .padding(.trailing, 22)
