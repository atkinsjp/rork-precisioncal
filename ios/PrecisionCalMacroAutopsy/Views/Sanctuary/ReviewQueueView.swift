...
struct ReviewQueueView: View {
    ...
    private var emptyState: some View {
        VStack(spacing: 14) {
            ZStack {
                Circle()
                    .fill(PrecisionCalMacroAutopsyTheme.sage.opacity(0.15))
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack(spacing: 10) {
                    ...
                    actionButton(label: "Approve",
                                 icon: "checkmark",
                                 fg: PrecisionCalMacroAutopsyTheme.sage,
                                 bg: Color.white.opacity(0.9),
                                 strokeColor: PrecisionCalMacroAutopsyTheme.sage,
                                 action: onApprove)
                }
                .padding(.top, 4)
            }
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 10) {
                ...
                Button(action: onApprove) {
                    ...
                    .foregroundStyle(PrecisionCalMacroAutopsyTheme.sage)
                    .padding(.horizontal, 12).padding(.vertical, 8)
                    .background(Capsule().stroke(PrecisionCalMacroAutopsyTheme.sage, lineWidth: 1))
                }
                .buttonStyle(.plain)
