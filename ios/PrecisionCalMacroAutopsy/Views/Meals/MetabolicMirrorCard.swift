...
struct MetabolicMirrorCard: View {
            ...
            RoundedRectangle(cornerRadius: 22, style: .continuous)
                ...
                .overlay {
                    ...
                    RoundedRectangle(cornerRadius: 22, style: .continuous)
                        .fill(
                            LinearGradient(
                                colors: [Color.white.opacity(0.0), PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.05)],
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.10), radius: 22, x: 0, y: 10)
        }
    }
    ...
    private func paragraph(_ s: String) -> some View {
        Text(s)
            ...
            .foregroundStyle(PrecisionCalMacroAutopsyTheme.textPrimary.opacity(0.92))
            .lineSpacing(5)
    ...
    private var energyTimingBlock: some View {
        HStack(alignment: .top, spacing: 12) {
            Image(systemName: meal.lipidSheenDetected ? "drop.fill" : "clock")
                .font(.system(size: 14, weight: .semibold))
                .foregroundStyle(meal.lipidSheenDetected ? PrecisionCalMacroAutopsyTheme.fatColor : PrecisionCalMacroAutopsyTheme.terracotta)
                .frame(width: 28, height: 28)
                .background {
                    Circle().fill(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.10))
                }
                ...
                HStack(spacing: 6) {
                    ...
                    if meal.lipidSheenDetected {
                        Text("4H")
                            ...
                            .padding(.vertical, 2)
                            .background(PrecisionCalMacroAutopsyTheme.fatColor, in: Capsule())
                    }
                }
        ...
        .background {
            RoundedRectangle(cornerRadius: 16, style: .continuous)
                .fill(meal.lipidSheenDetected
                      ? PrecisionCalMacroAutopsyTheme.fatColor.opacity(0.08)
                      : PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.06))
        }
    }
