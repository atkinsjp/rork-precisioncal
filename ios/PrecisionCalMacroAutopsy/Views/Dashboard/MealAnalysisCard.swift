        ...
        Button(action: onTap) {
            HStack(spacing: 14) {
                ZStack {
                    ...
                    Image(systemName: "camera.viewfinder")
                        ...
                        .foregroundStyle(
                            LinearGradient(
                                colors: [PrecisionCalMacroAutopsyTheme.sage, PrecisionCalMacroAutopsyTheme.sageLight],
                                startPoint: .topLeading, endPoint: .bottomTrailing
                            )
                        )
                }
            ...
            .background {
                RoundedRectangle(cornerRadius: 22, style: .continuous)
                    ...
                    .shadow(color: PrecisionCalMacroAutopsyTheme.sage.opacity(0.35), radius: 16, x: 0, y: 10)
            }
