...
struct DashboardView: View {
    ...
    private var header: some View {
        VStack(spacing: 18) {
            Image("AppLogo")
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.25), radius: 24, x: 0, y: 12)
    ...
    private var bloomSection: some View {
        VStack(spacing: 14) {
            ...
            HStack(spacing: 18) {
                BloomLegend(label: "Hydration", value: hydrationProgress, color: PrecisionCalMacroAutopsyTheme.hydrationColor)
                BloomLegend(label: "Macros", value: macroProgress, color: PrecisionCalMacroAutopsyTheme.carbColor)
                BloomLegend(label: "Adherence", value: adherence, color: PrecisionCalMacroAutopsyTheme.terracotta)
            }
    ...
    private var quickActionsRow: some View {
        HStack(spacing: 10) {
            QuickActionTile(
                title: "Meals",
                icon: "fork.knife",
                color: PrecisionCalMacroAutopsyTheme.sage
            ) { showMeals = true }

            QuickActionTile(
                title: "Water",
                icon: "drop.fill",
                color: PrecisionCalMacroAutopsyTheme.hydrationColor
            ) { showWater = true }
            ...
            QuickActionTile(
                ...
                color: PrecisionCalMacroAutopsyTheme.terracotta
            ) { showTrends = true }
        }
    }
    ...
    var body: some View {
        GlassCard {
            HStack(spacing: 18) {
                ZStack {
                    Circle()
                        .stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.5), lineWidth: 8)
                        .frame(width: 78, height: 78)
                    Circle()
                        .trim(from: 0, to: progress)
                        .stroke(
                            LinearGradient(colors: [PrecisionCalMacroAutopsyTheme.hydrationColor, PrecisionCalMacroAutopsyTheme.sageLight], startPoint: .top, endPoint: .bottom),
...
struct MealScoreBadge: View {
    ...
    private var color: Color {
        switch score {
        case 80...: return PrecisionCalMacroAutopsyTheme.sage
        case 60..<80: return PrecisionCalMacroAutopsyTheme.fatColor
        default: return PrecisionCalMacroAutopsyTheme.terracotta
        }
    }
