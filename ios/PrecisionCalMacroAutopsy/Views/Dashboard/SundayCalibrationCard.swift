    ...
    var body: some View {
                ...
                Button {
                    ...
                    Text("Begin the week")
                        ...
                        .background {
                            ...
                            .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.3), radius: 8, x: 0, y: 4)
                        }
                }
        ...
        .background {
            RoundedRectangle(cornerRadius: 24, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 24, style: .continuous)
                        .stroke(
                            LinearGradient(
                                colors: [
                                    PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.45),
                                    PrecisionCalMacroAutopsyTheme.glassStroke,
                                ],
                                startPoint: .topLeading, endPoint: .bottomTrailing
                            ),
                            lineWidth: 1
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.10), radius: 18, x: 0, y: 10)
        }
    ...
    var body: some View {
        HStack(alignment: .top, spacing: 12) {
            Text("\(index)")
                ...
                .background {
                    Circle()
                        .stroke(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.55), lineWidth: 1.2)
        ...
        .background {
            RoundedRectangle(cornerRadius: 16, style: .continuous)
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 16, style: .continuous)
                        .stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.5), lineWidth: 1)
                }
        }
        .opacity(visible ? 1 : 0)
