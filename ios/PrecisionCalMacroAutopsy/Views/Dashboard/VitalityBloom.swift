    ...
    private func outerGlow(t: TimeInterval) -> some View {
        ...
        return Circle()
            .fill(
                RadialGradient(
                    colors: [
                        PrecisionCalMacroAutopsyTheme.terracotta.opacity(intensity * 0.55),
                        PrecisionCalMacroAutopsyTheme.terracotta.opacity(intensity * 0.20),
                        .clear
                    ],
                    center: .center,
    ...
    private func core(t: TimeInterval) -> some View {
        ...
        return ZStack {
            Circle()
                .fill(
                    RadialGradient(
                        colors: [Color.white.opacity(0.95),
                                 PrecisionCalMacroAutopsyTheme.parchment.opacity(0.85),
                                 PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.18)],
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.25), radius: 12)
            Circle()
