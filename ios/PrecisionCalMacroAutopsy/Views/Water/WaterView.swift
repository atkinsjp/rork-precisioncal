            ...
            .background {
                ZStack {
                    ...
                    Circle()
                        .fill(
                            RadialGradient(
                                colors: [PrecisionCalMacroAutopsyTheme.hydrationColor.opacity(0.45), PrecisionCalMacroAutopsyTheme.hydrationColor.opacity(0.0)],
                        ...
                        ForEach([("8 oz", 8.0), ("12 oz", 12.0), ("16 oz", 16.0), ("20 oz", 20.0)], id: \.0) { item in
                            Button {
                                ...
                                Text(item.0)
                                    ...
                                    .frame(maxWidth: .infinity)
                                    .padding(.vertical, 8)
                                    .background(PrecisionCalMacroAutopsyTheme.hydrationColor.opacity(0.15), in: .rect(cornerRadius: 10))
                                    .foregroundStyle(PrecisionCalMacroAutopsyTheme.hydrationColor)
                            }
                            .buttonStyle(.plain)
                        }
