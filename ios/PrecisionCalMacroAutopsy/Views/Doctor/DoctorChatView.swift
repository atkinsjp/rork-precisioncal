            ...
            .overlay(alignment: .top) {
                if let toast = errorToast {
                    Text(toast)
                        ...
                        .background(Capsule().fill(PrecisionCalMacroAutopsyTheme.terracottaDeep.opacity(0.95)))
                        .padding(.top, 8)
        ...
        HStack(spacing: 12) {
            ZStack {
                Circle()
                    ...
                    .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.35), radius: 10, x: 0, y: 6)
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                HStack(spacing: 5) {
                    Circle()
                        .fill(PrecisionCalMacroAutopsyTheme.sage)
                    ...
                    Button {
                        ...
                        .background {
                            Capsule()
                                .fill(.ultraThinMaterial)
                                .overlay(
                                    Capsule().stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.6), lineWidth: 1)
                                )
                        }
                    }
                    .buttonStyle(.plain)
            ...
            HStack(alignment: .bottom, spacing: 10) {
                ...
                .background {
                    RoundedRectangle(cornerRadius: 22, style: .continuous)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 22, style: .continuous)
                                .stroke(PrecisionCalMacroAutopsyTheme.glassStroke.opacity(0.7), lineWidth: 1)
                        )
                }
                    ...
                    ZStack {
                        Circle()
                            .fill(
                                LinearGradient(
                                    colors: canSend
                                        ? [PrecisionCalMacroAutopsyTheme.terracotta, PrecisionCalMacroAutopsyTheme.terracottaDeep]
                                        : [PrecisionCalMacroAutopsyTheme.glassStroke, PrecisionCalMacroAutopsyTheme.glassStroke],
                                    startPoint: .topLeading, endPoint: .bottomTrailing
                                )
                            )
                            .frame(width: 44, height: 44)
                            .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(canSend ? 0.35 : 0), radius: 10, x: 0, y: 6)
                        if sending {
                ...
                Text(message.content)
                    ...
                    .background {
                        RoundedRectangle(cornerRadius: 18, style: .continuous)
                            ...
                            .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.3), radius: 10, x: 0, y: 6)
                    }
            }
        } else {
            HStack(alignment: .top, spacing: 10) {
    ...
    private func doctorBubbleContent(_ parsed: ParsedReply) -> some View {
            ...
            if !parsed.sources.isEmpty {
                ...
                .background {
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .fill(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.06))
                        .overlay(
                            RoundedRectangle(cornerRadius: 12, style: .continuous)
                                .stroke(PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.18), lineWidth: 0.8)
                        )
                }
            }
        ...
        .background {
            RoundedRectangle(cornerRadius: 18, style: .continuous)
                ...
                .shadow(color: PrecisionCalMacroAutopsyTheme.terracotta.opacity(0.05), radius: 6, x: 0, y: 3)
        }
    }
    ...
    private func highlightCitations(_ text: String) -> AttributedString {
        ...
        for match in matches.reversed() {
            ...
            if let range = attr.range(of: token, options: .backwards) {
                ...
                attr[range].foregroundColor = PrecisionCalMacroAutopsyTheme.terracotta
        ...
        HStack(alignment: .top, spacing: 10) {
            ...
            HStack(spacing: 6) {
                ForEach(0..<3, id: \.self) { i in
                    Circle()
                        .fill(PrecisionCalMacroAutopsyTheme.terracotta.opacity(phase == i ? 0.95 : 0.35))
